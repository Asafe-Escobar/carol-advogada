...
const InfoChip = ({ icon, text }: { icon: React.ReactNode; text: string }) => (
  <div className="inline-flex items-center gap-2.5 rounded-full border-2 border-[#E6B324]/70 bg-gradient-to-br from-black/75 via-black/60 to-black/50 backdrop-blur-xl px-4 py-2.5 shadow-[0_6px_20px_rgba(0,0,0,0.6),0_0_0_1px_rgba(230,179,36,0.2)_inset] transition-all duration-300 hover:border-[#E6B324] hover:bg-gradient-to-br hover:from-black/85 hover:to-black/65 hover:shadow-[0_8px_30px_rgba(230,179,36,0.4),0_0_20px_rgba(230,179,36,0.3)] hover:scale-105 hover:-translate-y-0.5 cursor-default group md:px-5 md:py-3.5">
    <span className="text-[12px] text-white font-bold tracking-wide uppercase md:text-[15px]" style={{ textShadow: '0 2px 8px rgba(0,0,0,0.9), 0 0 10px rgba(255,255,255,0.2)' }}>{text}</span>
  </div>
);
        ...
        <div className="flex flex-1 items-start px-5 pt-0 pb-1 md:px-24 md:pt-16 md:pb-6 md:items-center">
          <div className="w-full max-w-md md:max-w-4xl">
            ...
            <div className="space-y-2 md:space-y-8">
              ...
              <div 
                className="flex flex-wrap gap-2.5 opacity-0 animate-fade-in md:gap-5"
        ...
        <div className="px-5 pb-4 md:px-24 md:pb-10">
          ...
          >
            <a
              ...
              className="group relative inline-flex w-full items-center justify-center gap-2.5 rounded-xl bg-[#25D366] px-6 py-4 text-[13px] font-extrabold uppercase tracking-wide text-white shadow-[0_10px_30px_rgba(37,211,102,0.4)] transition-all hover:bg-[#22C55E] hover:shadow-[0_15px_40px_rgba(37,211,102,0.5)] hover:scale-[1.02] active:scale-[0.98] duration-300 md:text-[18px] md:py-7 md:px-10 md:max-w-2xl md:rounded-2xl"
              aria-label="Entrar no grupo do WhatsApp para receber o link da palestra"
            >
              <svg className="h-5 w-5 group-hover:scale-110 transition-transform duration-300 md:h-7 md:w-7" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span>Quero participar da palestra</span>
            </a>
          </div>
        </div>
