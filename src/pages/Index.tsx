        ...
        <div className="flex flex-1 items-start px-5 pt-0 pb-1 md:px-24 md:pt-16 md:pb-6 md:items-center">
          <div className="w-full max-w-md md:max-w-4xl">
            ...
            <div className="space-y-1 md:space-y-8">
              ...
              >
                Existe um benefício assistencial previsto em lei — o BPC/LOAS — que pode ajudar quando há impedimentos de longo prazo e vulnerabilidade social. Vou esclarecer esse tema com responsabilidade, explicando quando se aplica, quem pode ter direito e como funciona o processo.{" "}
                <span className="text-[#E6B324] font-bold drop-shadow-[0_2px_10px_rgba(230,179,36,0.6)]">Sem promessas, sem juridiquês. Conteúdo claro, técnico e acessível.</span>
              </p>
