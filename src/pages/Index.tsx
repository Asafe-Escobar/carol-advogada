        ...
        <div className="px-5 pb-4 md:px-24 md:pb-10">
          ...
          >
            <a
              ...
              className="group relative inline-flex w-full items-center justify-center gap-3 rounded-xl bg-gradient-to-b from-[#25D366] to-[#22C55E] px-7 py-5 text-[14px] font-extrabold uppercase tracking-wide text-white shadow-[0_10px_30px_rgba(37,211,102,0.5),inset_0_1px_0_rgba(255,255,255,0.25)] transition-all hover:from-[#22C55E] hover:to-[#20B559] hover:shadow-[0_14px_40px_rgba(37,211,102,0.6)] hover:scale-[1.03] active:scale-[0.98] duration-300 md:text-[18px] md:py-6 md:px-10 md:max-w-xl"
